...
const std::string MODEL_PATH = "geo/chalet.obj";
...
class HelloTriangleApplication {
	...
	private:
		...
		void reportGlfwRequiredExtensions(){
			uint32_t glfwExtensionCount = 0;
			const char** glfwExtensions;
			glfwExtensions = glfwGetRequiredInstanceExtensions(&glfwExtensionCount);
		...
		void reportSupportedExtensions(){
		...
		void createDescriptorSetLayout() {
			VkDescriptorSetLayoutBinding ubuLayoutBinding = {};
			ubuLayoutBinding.binding = 0;
			ubuLayoutBinding.descriptorType = VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
			ubuLayoutBinding.descriptorCount = 1;
		...
		void createGraphicsPipeline() {
			...
			rasterizer.cullMode = VK_CULL_MODE_NONE; //my edit
		...
		void createSwapChain() 
		{
			...
			//if maxImageCount == 0 that means there is no limit
			if (
		...
		//moved parts of this function to beginSingleTimeCommands and
		...
		void reportDeviceName(VkPhysicalDevice device){
...
//			updateUniformBuffer(imageIndex);
			myUpdateUniformBuffer(imageIndex);
